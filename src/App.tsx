...
import { KeywordTrends } from './components/trends/KeywordTrends';
import { ExportPanel } from './components/export/ExportPanel';
import { KeywordAnalytics } from './components/analytics/KeywordAnalytics';
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="space-y-6">
            ...
            {generatedKeywords.length > 0 && (
              <>
                <KeywordTrends />
                <ExportPanel keywords={generatedKeywords} />
              </>
            )}
          </div>
          <div className="space-y-6">
            ...
            {generatedKeywords.length > 0 && (
              <KeywordAnalytics keywords={generatedKeywords} />
            )}
            <Card className="p-6">
              <QuestionFinder />
            </Card>
